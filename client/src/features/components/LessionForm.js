      ...
      {!currentLesson ? (
        ...
        >
          <div className="text-center">
            <h4 className="fw-bold mb-2">No Lesson Selected</h4>
        ...
        <>
          ...
          >
            <div className="d-flex justify-content-between align-items-start flex-wrap gap-3">
              <div>
                <h2 className="fw-bold mb-2">{currentLesson?.content}</h2>
              ...
              {role !== "student" && (
                <div className="d-flex gap-2">
                  <Link to={`/update_lession/${currentLesson._id}`}>
                    <CButton color="primary">Update Lesson</CButton>
                  </Link>
          ...
          >
            <div className="d-flex justify-content-between align-items-center mb-4">
              <h5 className="fw-bold mb-0">Lesson Resources</h5>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="d-flex align-items-center gap-3">
                      ...
                      <div>
                        <div className="fw-semibold">{src?.title}</div>
