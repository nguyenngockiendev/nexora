  ...
  return (
    <div className="space-y-10">
      ...
      >
        ...
        <div
          className="absolute -top-32 -right-20 w-[500px] h-[500px] rounded-full opacity-20 pointer-events-none animate-pulse"
          style={{
        ...
        />
        <div
          className="absolute -bottom-32 -left-20 w-[400px] h-[400px] rounded-full opacity-10 pointer-events-none"
          style={{
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-10 w-full">
          ...
          <div className="max-w-xl">
            <div
              className="inline-flex items-center gap-2 rounded-full px-3 py-1.5 text-xs font-bold uppercase tracking-widest mb-6"
              style={{
            ...
            >
              ...
              own pace with our meticulously crafted recorded courses.
            </p>
          </div>
          ...
          <div className="hidden lg:block relative w-[400px] h-[280px] perspective-1000">
            {/* Card 3 (Back) */}
            <div
              className="absolute top-8 right-12 w-64 h-40 rounded-2xl opacity-40 transform translate-x-12 -translate-y-8 rotate-12 scale-90"
              style={{
            ...
            {/* Card 2 (Middle) */}
            <div
              className="absolute top-4 right-6 w-64 h-40 rounded-2xl opacity-70 transform translate-x-6 -translate-y-4 rotate-6 scale-95"
              style={{
            ...
            {/* Card 1 (Front) */}
            <div
              className="absolute top-0 right-0 w-72 h-44 rounded-2xl shadow-2xl transform transition-transform hover:-translate-y-2 hover:rotate-2 duration-500 flex flex-col justify-between p-5"
              style={{
                background: "rgba(255,255,255,0.85)",
                border: "1px solid rgba(255,255,255,1)",
                backdropFilter: "blur(16px)",
                boxShadow: "0 20px 40px rgba(194,110,30,0.15)",
              }}
            >
              <div className="flex justify-between items-start">
                ...
                <span className="px-2 py-1 rounded bg-rose-100 text-rose-600 text-[10px] font-bold">
                  ● LIVE
                </span>
              </div>
              <div>
      ...
      {loading && (
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {Array.from({ length: 4 }).map((_, i) => (
            <div
              key={i}
              className={`rounded-3xl animate-pulse ${i === 0 ? "sm:col-span-2 row-span-2 h-[400px]" : "h-[300px]"}`}
              style={{
            ...
            return (
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    "inset 0 1px 0 rgba(255,255,255,0.9), 0 8px 32px rgba(194,110,30,0.06)",
                }}
                onMouseMove={(e) => {
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(249,115,22,0.08), transparent 40%)",
                  }}
                />

                {/* Thumbnail Container */}
                <div
                  className={`relative overflow-hidden bg-slate-100 ${isFeatured ? "h-64 sm:h-72" : "h-40"}`}
                >
                  <img
                    src={cou?.thumbnail}
                    alt={cou?.title}
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to top, rgba(255,255,255,0.5) 0%, transparent 60%)",
                    }}
                  />
                ...
                {/* Card Body */}
                <div
                  className={`flex flex-col flex-1 gap-3 relative z-20 ${isFeatured ? "p-6 lg:p-8" : "p-4"}`}
                >
                  <h3
                    className={`font-bold leading-snug line-clamp-2 ${isFeatured ? "text-2xl min-h-[4rem]" : "text-[1rem] min-h-[2.5rem]"}`}
                    style={{ color: "#1e293b" }}
                  >
                    {cou?.title}
                  </h3>
                  ...
                  <p
                    className={`line-clamp-3 leading-relaxed flex-1 ${isFeatured ? "text-sm" : "text-xs line-clamp-2"}`}
                    style={{ color: "#64748b" }}
                  >
                    {cou?.description}
                  </p>
                  ...
                  <div
                    className={`mt-2 pt-4 border-t ${isFeatured ? "pt-6 mt-4" : ""}`}
                    ...
                    <div className="flex gap-2">
                      ...
                      {role === "student" && (
                        <button
                          ...
                          style={{
                            background:
                              "linear-gradient(135deg, rgba(249,115,22,0.9), rgba(251,146,60,0.8))",
      ...
      {!loading && courses?.length === 0 && (
        ...
        >
          <Search
            ...
            className="mb-4"
          />
          <h4 className="text-xl font-bold mb-2" style={{ color: "#1e293b" }}>
            No courses found
          </h4>
