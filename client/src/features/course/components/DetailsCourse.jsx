        ...
        <div className="lg:col-span-2 space-y-8">
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs font-semibold text-slate-400 pt-2">
              <div className="flex items-center gap-1">
                ...
                <span className="text-slate-600">
                  {detalscourse?.instructor?.name}
                </span>
              </div>
              <div className="flex items-center gap-1">
                <Globe size={14} /> Cấp độ:{" "}
                <span className="text-slate-600">{detalscourse?.level}</span>
              </div>
              <div className="flex items-center gap-1">
          ...
          <div
            ...
            style={{
              ...
              boxShadow:
                "inset 0 1px 0 rgba(255,255,255,0.9), 0 8px 32px rgba(194,110,30,0.04)",
            }}
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {(detalscourse?.benefits || []).map((benefit, i) => (
                <div
                  key={i}
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <div className="w-20 h-20 rounded-2xl overflow-hidden bg-slate-100 flex-shrink-0 border border-slate-200">
                <img
                  src={detalscourse?.instructor?.avatar}
                  alt={detalscourse?.instructor?.name}
        ...
        <div className="lg:sticky lg:top-8 space-y-6">
          ...
          >
            ...
            <div
              ...
              onClick={() =>
                handleOpenPreview(detalscourse?.lessons?.[0]?.videoUrl)
              }
            >
              <img
                src={detalscourse?.thumbnail}
                alt=""
            ...
            <div className="p-6 pt-4 space-y-6">
              ...
              <div className="pt-5 border-t border-slate-100 space-y-3.5 text-xs font-semibold text-slate-500">
                <div className="flex items-center gap-3">
                  ...
                  <span>
                    Thời lượng khóa học: {Math.round(totalDuration / 60)} giờ
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-lg bg-orange-50 text-orange-500 flex items-center justify-center">
                  ...
                  <span>
                    Tổng số bài học: {(detalscourse?.lessons || []).length} bài
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-lg bg-orange-50 text-orange-500 flex items-center justify-center">
