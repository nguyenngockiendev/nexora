      ...
      <section className="grid gap-6 xl:grid-cols-[2fr_1fr]">
          ...
          <div className="mb-6 flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-slate-500 font-medium mt-1">
                Xu hướng tăng trưởng dòng tiền
              </p>
            </div>
        ...
        >
          <div className="mb-6">
            ...
            <p className="text-sm text-slate-500 font-medium mt-1">
              Đăng ký mới theo {timeFilter === "week" ? "ngày" : "tháng"}
            </p>
          </div>
          <div className="h-[300px] w-full">
            {userChart.length > 0 ? (
      ...
      <section className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_minmax(380px,0.9fr)]">
        ...
        <div
          ...
          style={{
            ...
            backdropFilter: "blur(20px)",
            boxShadow:
              "inset 0 1px 0 rgba(255,255,255,0.9), 0 16px 48px rgba(168,85,247,0.06)",
          }}
        >
        ...
        <aside
          ...
          style={{
            ...
            backdropFilter: "blur(20px)",
            boxShadow:
              "inset 0 1px 0 rgba(255,255,255,0.9), 0 16px 48px rgba(236,72,153,0.06)",
          }}
        >
          <div className="mb-5 flex items-start justify-between gap-4">
            <div>
