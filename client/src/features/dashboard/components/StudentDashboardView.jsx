...
const StudentDashboardView = ({ dashboard, loading }) => {
  ...
  const upcomingLiveClasses = [
    {
      id: 1,
      title: "Hỏi đáp & Review Code ReactJS",
      date: "Hôm nay",
      time: "20:00 - 21:30",
    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      >
        ...
        <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1fr)_380px]">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(59,130,246,0.2) 0%, rgba(6,182,212,0.12) 100%)",
              border: "1px solid rgba(59,130,246,0.25)",
              boxShadow:
                "inset 0 1px 0 rgba(255,255,255,0.6), 0 8px 32px rgba(59,130,246,0.12)",
            }}
          >
            <div className="bg-white/80 backdrop-blur-xl rounded-[1.3rem] p-5 h-full flex flex-col justify-between">
              ...
              <div className="mt-5">
                ...
                <button
                  className="w-full py-2.5 rounded-xl text-white font-bold text-sm flex items-center justify-center gap-2 shadow-lg shadow-blue-500/30 hover:scale-[1.02] active:scale-[0.98] transition-all"
                  style={{
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <StatCard
          ...
          value={formatNumber(overview.enrolledCourses)}
        ...
        <StatCard
          ...
          value={formatNumber(overview.completedLessons)}
          helper="Rất chăm chỉ!"
          tone="green"
        />
        <StatCard
      ...
      <section className="grid gap-6 xl:grid-cols-2">
        ...
        <div
          ...
          style={{
            ...
            backdropFilter: "blur(20px)",
            boxShadow:
              "inset 0 1px 0 rgba(255,255,255,0.9), 0 16px 48px rgba(0,0,0,0.04)",
          }}
        >
          ...
          <div className="space-y-4">
            {upcomingLiveClasses.map((cls) => (
              <div
                key={cls.id}
                className="group flex items-center justify-between p-4 rounded-2xl border border-slate-100 bg-white/50 hover:bg-white hover:shadow-md transition-all cursor-pointer"
              >
