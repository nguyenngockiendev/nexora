    ...
    <div className="space-y-8 pb-10">
      ...
      {loading && (
        <div className="flex items-center justify-center gap-3 py-10 text-orange-500 font-bold">
          <Loader2 className="animate-spin" size={24} /> Loading your learning
          path...
        </div>
      )}
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-slate-200 overflow-hidden">
                    <img
                      src={`https://ui-avatars.com/api/?name=${item?.instructor?.name || "Ins"}&background=random`}
                      alt="instructor"
                    />
                  </div>
                ...
                <>
                  ...
                  <div className="space-y-2 mb-6">
                    <div className="flex items-center gap-3 text-sm font-medium text-slate-600">
                      ...
                      <span>
                        {item.completed.length} / {item.numberStudy.length} completed
                      </span>
                    </div>
                    <div className="flex items-center gap-3 text-sm font-medium text-slate-600">
                      ...
                      <span className="truncate">
                        ...
                        <strong className="text-slate-800">
                          {item?.nextLesson?.title || "Course Completed! 🎉"}
                        </strong>
                      </span>
                    </div>
                    <div className="flex items-center gap-3 text-sm font-medium text-slate-600">
                ...
                <div className="flex justify-center items-center gap-3 w-full">
                  {item?.type === "recorded" ? (
                    ...
                    <>
                      ...
                      >
                        <button
                          className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-full text-sm font-black text-white shadow-lg shadow-orange-500/30 hover:scale-[1.02] active:scale-95 transition-all border border-orange-400"
                          style={{
                            background:
                              "linear-gradient(135deg, #f97316, #ea580c)",
                          }}
                        >
                          <Video size={18} className="animate-pulse" /> Join
                          Live Room
                        </button>
                      </Link>
                    </>
